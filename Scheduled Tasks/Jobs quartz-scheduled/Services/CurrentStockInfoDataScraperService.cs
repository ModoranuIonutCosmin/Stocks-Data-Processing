...
public class CurrentStockInfoDataScraperService : ICurrentStockInfoDataScraperService
{
    ...
    /// <summary>
    /// </summary>
    /// <param name="currentStockYahooService">
    ///     Serviciul ce obtine date despre pretul
    ///     curent de pe Y! Finance
    /// </param>
    /// <param name="currentStockGoogleService">
    ///     Serviciul ce obtine date despre pretul
    ///     curent de pe Google Finance
    /// </param>
