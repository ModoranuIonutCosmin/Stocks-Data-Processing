    ...
    IStockPricesRepository
{
    ...
    {
        return _dbContext.PricesData.OrderBy(e => e.Date)
    ...
    public async Task<List<StocksPriceData>> GetPredictionsForTickerAndAlgorithmPaginated(string ticker,
        string algorithm, int page,
        int count)
    {
